...
if __name__ == "__main__":
    ...
    info_urls = {
        ...
        "dataset14": "https://blobserver.dc.scilifelab.se/blob/new_slu_ww_data.csv/info",
        "dataset17": "https://blobserver.dc.scilifelab.se/blob/wastewater_data_gu_allviruses.xlsx/info.json",
        "dataset19": "https://blobserver.dc.scilifelab.se/blob/new_slu_ww_data.csv/info",
        "dataset21": "https://blobserver.dc.scilifelab.se/blob/new_slu_ww_data.csv/info",
